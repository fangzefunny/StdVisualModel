classdef normCEModel2 < contrastModel 
    ...
    methods
        ...
        % init the model
        function model = normCEModel2(optimizer, fittime, param_bound, param_pbound)
       ...
       % function: f()
        ...
        function [loss, param, loss_history]  = optim(model, E, BOLD_tar, verbose)
           ...
           % set up the loss function
            func=@(x) model.loss_fn(x, model, E, BOLD_tar);
            ...
            switch cross_valid
                ...
                case 'cross_valid'
                    ...
                    for knock_idx = stim_vector
                        ...
                        [loss, param, loss_history] = model.optim(model, E_train, tar_train, verbose);
