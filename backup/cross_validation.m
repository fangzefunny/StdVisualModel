        ...
        case 'space'
            ...
            switch which_model
                case 'SOC'
                    ...
                    % Assign into the right dataset
                    E_space = E_test( :, :, :, :, knock_index); % X x Y x example x 1
                    ...
                    d = bsxfun(@times, v, w_d);  % X x Y x ep x 1
                ...
                case 'ori_surround'
                    ...
                    % Assign into the right dataset
                    E_space = E_test( :, :, :, :, knock_index); % X x Y x ori x example x 1
                    weight_E = weight_E_test( :, :, :, :, knock_index ); % X x Y x ori x example x 1
